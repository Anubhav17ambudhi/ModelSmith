...
def start_automl(csv_path, target, use_case, user_req):
    ...
    study.optimize(objective, n_trials=30) # Testing ke liye 30 trials set hain
    ...
    _ = test_saved_model(model_save_path, study.best_params, input_state, X_test, y_test, scaler_y)


import argparse

if __name__ == "__main__":
    # Command Line Arguments setup for Frontend/API Integration
